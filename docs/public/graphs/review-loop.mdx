...
```json
{"decision":{"kind":"complete","output":{"iterations":1,"restarts":0,"seats":{"claude-review":"accepted","codex-review":"accepted"},"findings":[]}},"events":8,"planDigest":"sha256:b6a6fab0333c87a17016b8b1953ef7b77762d930e4fde327addf5e237ae5ae75","bounds":{"dispatches":{"min":{"kind":"known","value":4},"max":{"kind":"known","value":11}},"maxConcurrency":{"kind":"known","value":2},"maxFanOut":{"kind":"known","value":2}}}
```
...
- **Review records:** A seat pass includes its confidence, input hashes, and
  ...
  the seat again while its retry limit permits. The seat's lane declares the
