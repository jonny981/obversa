...
unanswered: a step that's going nowhere, half an hour into an hour's
budget.

A supervised step is watched while it works. Its own events feed a fast
decision model on a debounce, which answers a few typed questions. Then
the run carries on, stops and retries, or puts the step in front of a
person.

The step doesn't pause to be assessed. The work keeps going while the
