...
| `SupervisedRunError` | A runner failure with a typed code. |
| `SupervisedRunOptions`, `ResumeSupervisedRunOptions`, `SupervisedRunStatus`, `SupervisedRunUsage` | The option and status types. |
