...
`@obversa/engine-codex-cli` is an engine plugin that runs requests through the `codex` command-line interface. It provides an OpenAI-backed engine for verification and review seats.
