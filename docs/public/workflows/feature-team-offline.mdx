...
description: "Five stages, a panel of three that passes on two, and a person at the end, with no model behind any of them."
---

You've read that a team of coding agents can review its own work and run a
step again when the review fails. Before you sign anything in, you want to
see that mechanism move: a panel that says no, the writer that runs again,
the second attempt that passes.
