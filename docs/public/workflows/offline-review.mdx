...
description: "Run a bounded workflow that acts on review feedback before it passes."
---
...
Copy `examples/workflows/offline-review.workflow.ts` from the repository.
...
```bash
pnpm exec tsx offline-review.workflow.ts
```
