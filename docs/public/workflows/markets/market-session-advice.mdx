...
description: "A session host reads recorded observations, a typed assessment routes each one, an uncertain one is researched, and a question waits for the person where action would be considered."
---
