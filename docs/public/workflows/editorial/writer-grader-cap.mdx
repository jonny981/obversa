...
description: "Another model grades the draft. The editor decides what is published."
---
...
the style guide and returns findings; the writer runs again with them, up to three times. When a draft holds, the run stops for
