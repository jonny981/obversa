...
Each page carries one real run. Two reached their person and stopped there.
The third did not finish: its reviewer sent the work back three times and the
loop stopped rather than pass on stories nobody had agreed. That is the same
promise kept from the other end, and the page says so.
