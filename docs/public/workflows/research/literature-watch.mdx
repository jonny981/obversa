...
description: "A model summarises the supplied papers, a person decides paper by paper which summaries enter the lab's memory, and a question is answered from the kept notes alone."
---
