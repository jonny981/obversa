...
description: "Run a bounded line that acts on review feedback before it passes."
---

Use this production line to learn the review and revision path without a model
...
After you copy the source into a project that has `@obversa/lines` and `tsx`
installed, run:
