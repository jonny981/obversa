...
description: "One question to a person as a step. Yes passes, no goes to the step that owns the fix with the note, and silence pauses the run."
---
...
```ts examples/approval.ts (excerpt) {8}
