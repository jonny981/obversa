...
review loops. Your own graph types use the same public contract.
...
A fresh executor checks that the graph supplied by the host matches the
stored definition and plan before it runs work. This check does not freeze
