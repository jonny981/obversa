...
| The workers | Model calls the framework makes for each agent. | CLI coding engines such as Claude Code, Codex, Grok and OpenCode run one fresh process per call. |
