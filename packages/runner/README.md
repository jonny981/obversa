...
- **Process cleanup:** Linux can discover descendants by their inherited run
  owner. On macOS a helper that moves into a new session before the watchdog
  samples it is not swept. The run record reports the cleanup capability.
