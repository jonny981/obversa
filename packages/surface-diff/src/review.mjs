 ...
 * @obversa/surface's runSurface) and the surface client-kit source. The
 * package's own command binds @obversa/surface to that port; the injection
...
export async function reviewDiff({
  ...
  // the surface package's data contract refuses, after a page had opened.
