...
import { canonicalJson, cloneFrozenJson, digestJson, type JsonObject, type JsonValue, type Sha256Digest } from '../json.js';
import { validateActionDecision, type ActionDecision } from '../action-decision.js';
...
import type { CallbackEvent } from './client-contract.js';
import { callbackRequestDigest, createCallbackGate, type CallbackGateDefinition, type CallbackRequest } from './gate.js';
...
export function hasExactFields(value: JsonObject, fields: readonly string[]): boolean {
...
export interface StoredApprovalBindingInput {
  readonly request: CallbackRequest;
  readonly planDigest: Sha256Digest;
  readonly graph: AcceptedResultGraph;
...
export function bindingFromSubject(
