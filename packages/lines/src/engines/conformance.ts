...
import { validateAgentResult } from '../runtime/result-parts.js';
...
function requestFor(
  ...
  return {
    ...
    ...(fixture.request.lines === undefined
      ? {}
      : {
          lines: {
            ...fixture.request.lines,
            path: [...fixture.request.lines.path],
          },
        }),
    ...
    },
    {
      ...
      async run() {
        ...
        check(
          ...
          'Engine did not return the native structured value.',
        );
      },
    },
    {
      ...
      async run() {
        ...
        check(
          isDeepStrictEqual(tools, [
            { type: 'tool', name: 'read_file', phase: 'use' },
