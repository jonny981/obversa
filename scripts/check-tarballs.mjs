...
// package is pinned here: the API and runtime, their plugins, the runner,
...
export const EXPECTED_FILES = {
  ...
  '@obversa/runtime': [
    ...
    'package/dist/workflow-agent-response.d.ts',
    'package/dist/workflow-support.d.ts',
    'package/dist/workflow-support.js',
    'package/dist/workflow-support.js.map',
  ...
  '@obversa/api': [
    'package/LICENSE',
    'package/README.md',
    'package/dist/accepted-result-support.d.ts',
    'package/dist/accepted-result-support.js',
    'package/dist/accepted-result-support.js.map',
    'package/dist/action-decision.d.ts',
    'package/dist/approval-support.d.ts',
    'package/dist/approval-support.js',
    'package/dist/approval-support.js.map',
    'package/dist/artifacts/conformance.d.ts',
    'package/dist/artifacts/store.d.ts',
    'package/dist/budget.d.ts',
    'package/dist/callback/approval.d.ts',
    'package/dist/callback/client-contract.d.ts',
    'package/dist/callback/gate.d.ts',
    'package/dist/callback/stored-client.d.ts',
    'package/dist/chunk-*.js',
    'package/dist/chunk-*.js.map',
    ...
    'package/dist/engine-conformance.d.ts',
    ...
    'package/dist/events/store.d.ts',
    'package/dist/graph-commands.d.ts',
    'package/dist/graph-contract.d.ts',
    'package/dist/graph-executor.d.ts',
    'package/dist/graph-kernel.d.ts',
    'package/dist/graph-plan.d.ts',
    'package/dist/graph-type.d.ts',
    'package/dist/index.d.ts',
    ...
    'package/dist/memory-conformance.d.ts',
    'package/dist/memory-types.d.ts',
    'package/dist/model-identity.d.ts',
    'package/dist/node-data-context.d.ts',
    'package/dist/preflight-result.d.ts',
    'package/dist/proof/acceptance.d.ts',
    'package/dist/proof/artifact.d.ts',
    'package/dist/proof/cache.d.ts',
    ...
    'package/dist/run-definition-support.js',
    'package/dist/run-definition-support.js.map',
    'package/dist/run-definition.d.ts',
    'package/dist/storage/error.d.ts',
    'package/dist/storage/id.d.ts',
    'package/dist/testing.d.ts',
    'package/dist/testing.js',
  ...
  '@obversa/core': [
    ...
    'package/dist/claude-stream-json.js.map',
    'package/dist/claude-tools.d.ts',
    'package/dist/claude-tools.js',
    'package/dist/claude-tools.js.map',
